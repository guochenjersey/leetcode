 ...
 *
 * <p>Search for a node to remove. If the node is found, delete the node. Note: Time complexity
 ...
 * <p>5 / \ 3 6 / \ \ 2 4 7
 *
 * <p>Given key to delete is 3. So we find the node with value 3 and delete it.
 *
 * <p>One valid answer is [5,4,6,2,null,null,7], shown in the following BST.
 *
 * <p>5 / \ 4 6 / \ 2 7
 *
 * <p>Another valid answer is [5,2,6,null,4,null,7].
 *
 * <p>5 / \ 2 6 \ \ 4 7
 */
@LeetCode
...
public class DeleteANodeInBST {
  ...
  private TreeNode helper(TreeNode node, int key) {
    ...
    if (node.val == key && node.right == null && node.left == null) {
      return null;
    }
