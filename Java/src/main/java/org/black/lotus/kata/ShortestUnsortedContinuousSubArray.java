 ...
 * 10, 9] in ascending order to make the whole array sorted in ascending order. Note: Then length of
 * the input array is in range [1, 10,000]. The input array may contain duplicates, so ascending
 * order here means <=.
 */
@LeetCode
@FirstRound
