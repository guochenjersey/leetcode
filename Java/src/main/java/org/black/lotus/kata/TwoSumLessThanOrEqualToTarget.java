 ...
 *
 * <p>Have you met this question in a real interview? Example Given nums = [2, 7, 11, 15], target =
 * 24. Return 5. 2 + 7 < 24 2 + 11 < 24 2 + 15 < 24 7 + 11 < 24 7 + 15 < 25
 *
 * <p>Tags
 *
 * <p>solution: two pointer fix one side and move another, adjusting reference by own logic
 */
@FirstRound
@LintCode
@Accepted
