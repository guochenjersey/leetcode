 ...
 * the secret number.
 *
 * <p>Write a function to return a hint according to the secret number and friend's guess, use A to
 * indicate the bulls and B to indicate the cows.
 *
 * <p>Please note that both secret number and friend's guess may contain duplicate digits.
 *
 * <p>Example 1:
 *
 ...
 * <p>Output: "1A3B"
 *
 * <p>Explanation: 1 bull and 3 cows. The bull is 8, the cows are 0, 1 and 7. Example 2:
 *
 * <p>Input: secret = "1123", guess = "0111"
 *
 * <p>Output: "1A1B"
 *
 * <p>Explanation: The 1st 1 in friend's guess is a bull, the 2nd or 3rd 1 is a cow. Note: You may
 * assume that the secret number and your friend's guess only contain digits, and their lengths are
 * always equal.
 */
@LeetCode
@Medium
...
public class BullsAndCows {
  ...
  public String getHint(String secret, String guess) {
    ...
    int n = secret.length();
    /**
     * 在一圈遍历中，每当遇到重合值，则bulls的数字加一，否则我们将secret number中的数字计数加1， guess
     * number中的数字计数减一。这样的话，如果下一次遇到重复但是位置不同的值， 我们可以知道它是否已经在secret中或是guess中出现过。
     */
    for (int i = 0; i < n; i++) {
