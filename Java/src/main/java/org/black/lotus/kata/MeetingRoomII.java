 ...
 *
 * <p>Input: intervals = [(0,30),(5,10),(15,20)] Output: 2 Explanation: We need two meeting rooms
 * room1: (0,30) room2: (5,10),(15,20) Example2
 *
 * <p>Input: intervals = [(2,7)] Output: 1 Explanation: Only need one meeting room
 */
@LintCode
@Facebook
@Medium
