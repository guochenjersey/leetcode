 ...
 *
 * <p>Given an grid of integers, how many 3 x 3 "magic square" subgrids are there? (Each subgrid is
 * contiguous).
 *
 * <p>Example 1:
 *
 * <p>Input: [[4,3,8,4], [9,5,1,9], [2,7,6,2]] Output: 1 Explanation: The following subgrid is a 3 x
 * 3 magic square: 438 951 276
 *
 * <p>while this one is not: 384 519 762
 *
 * <p>In total, there is only one magic square inside the given grid. Note:
 *
