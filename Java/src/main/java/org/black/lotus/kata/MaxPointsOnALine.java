    ...
    for (int i = 0; i < points.length - 1; ++i) {
      for (int j = i + 1; j < points.length; ++j) {
        ...
        while (k < points.length) {
          ...
          BigInteger xY1 =
              new BigInteger(String.valueOf(xdiff))
                  .multiply(new BigInteger(String.valueOf(y1Diff)));
          BigInteger x1Y =
              new BigInteger(String.valueOf(x1diff))
                  .multiply(new BigInteger(String.valueOf(yDiff)));
