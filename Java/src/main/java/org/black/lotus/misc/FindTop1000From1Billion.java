...
/**
 * key part is to main a small top heap. After reading one new data, compares with the peek of the
 * heap, if it is bigger, remove the heap peek and push the new data into the heap and adjust the
 * heap. The time O should be O(n * time(heap adjust));
 */
